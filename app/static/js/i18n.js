...
window.GuestI18n = {
  ...
  t: {
    fr: {
      ...
      intro_time: "Environ 5 minutes",
      intro_need_title: "Ce dont vous avez besoin",
      intro_need_body: "Une photo ou un PDF de votre pièce d'identité, vos dates de séjour et une signature à l'écran.",
      intro_next_title: "Et ensuite ?",
      intro_next_body: "Votre hôte reçoit votre enregistrement, vérifie votre identité et prépare votre arrivée.",
      intro_secure_title: "Vos données sont protégées",
      intro_secure_body: "Votre pièce d'identité est supprimée 14 heures après vérification par l'hôte.",
      ...
      progress_step_of: "Étape",
      progress_of: "sur",
      progress_step_info: "Informations",
      progress_step_rules: "Règlement",
      progress_step_sign: "Signature",
      progress_step_submit: "Envoi",
      section_submit: "Prêt à envoyer",
      section_submit_hint: "Vérifiez vos informations ci-dessus, puis envoyez votre enregistrement.",
      id_upload_ok: "Document reçu ✓",
    ...
    en: {
      ...
      intro_time: "About 5 minutes",
      intro_need_title: "What you need",
      intro_need_body: "A photo or PDF of your ID (passport or ID card), your travel dates, and a quick on-screen signature.",
      intro_next_title: "What happens next",
      intro_next_body: "Your host receives your registration, verifies your ID, and prepares your arrival. You only fill this form once per stay.",
      intro_secure_title: "Your data is protected",
      intro_secure_body: "Your ID scan is deleted 14 hours after the host verifies it. We only keep what is required for legal registration.",
      ...
      progress_step_of: "Step",
      progress_of: "of",
      progress_step_info: "Information",
      progress_step_rules: "Rules",
      progress_step_sign: "Signature",
      progress_step_submit: "Submit",
      section_submit: "Ready to submit",
      section_submit_hint: "Check your details above, then send your registration to your host.",
      id_upload_ok: "Photo received ✓",
      form_welcome_label: "Tigmy Host Shield",
    ...
    ar: {
      ...
      intro_time: "حوالي 5 دقائق",
      intro_need_title: "ما تحتاجونه",
      intro_need_body: "صورة أو PDF لوثيقة الهوية وتواريخ الإقامة وتوقيع على الشاشة.",
      intro_next_title: "ماذا بعد؟",
      intro_next_body: "يستلم المضيف تسجيلكم ويتحقق من الهوية ويجهز استقبالكم.",
      intro_secure_title: "بياناتكم محمية",
      intro_secure_body: "تُحذف نسخة الهوية بعد 14 ساعة من تحقق المضيف.",
      intro_id_note: "سترفعون نسخة من وثيقة الهوية. تُحذف بعد 14 ساعة من تحقق المضيف.",
      intro_subtitle: "اختر لغتك",
      progress_step_of: "الخطوة",
      progress_of: "من",
      progress_step_info: "المعلومات",
      progress_step_rules: "اللوائح",
      progress_step_sign: "التوقيع",
      progress_step_submit: "الإرسال",
      section_submit: "جاهز للإرسال",
      section_submit_hint: "راجعوا معلوماتكم ثم أرسلوا التسجيل للمضيف.",
      id_upload_ok: "تم استلام الملف ✓",
      form_welcome_label: "Tigmy Host Shield",
